...
<div class="max-w-3xl mx-auto bg-white p-8 rounded shadow">
    <h1 class="text-2xl font-bold text-center mb-6">Add New Port</h1>
    ...
    <form method="POST" action="{{ route('ports.store') }}">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="number" name="docking_capacity" id="docking_capacity" value="{{ old('docking_capacity') }}"
            ...
            <div>
                ...
                <input type="number" step="0.1" name="max_vessel_size" id="max_vessel_size" value="{{ old('max_vessel_size') }}"
                    class="w-full mt-1 p-2 border rounded">
            </div>
            ...
            <div>
                ...
                <input type="number" step="0.1" name="depth" id="depth" value="{{ old('depth') }}"
                    class="w-full mt-1 p-2 border rounded">
            </div>
            ...
            <div class="flex items-center mt-6">
                <input type="checkbox" name="customs_authorized" id="customs_authorized" value="1"
                    class="mr-2" {{ old('customs_authorized') ? 'checked' : '' }}>
                <label for="customs_authorized">Customs Authorized</label>
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="port_manager" id="port_manager" value="{{ old('port_manager') }}"
                    class="w-full mt-1 p-2 border rounded">
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="port_contact_info" id="port_contact_info" value="{{ old('port_contact_info') }}"
                    class="w-full mt-1 p-2 border rounded">
            </div>
        </div>
...
<script type="module">
    import { setupAutoCoordinates } from '/js/components/fetchCoordinates.js';
    setupAutoCoordinates({});
</script>
